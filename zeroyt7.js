...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        const sendButVideo = async (from, context, fortext, vid, but, mek) => {
            jadinya = await zeroyt7.prepareMessage(from, vid, video)
            buttonMessagesV = {
            ...
            zeroyt7.sendMessage(from, buttonMessagesV, buttonsMessage, {
                quoted: ftrol
            })
        }
        const sendList = async (from, buntex, desc, sections, mek) => {
            ...
            zeroyt7.sendMessage(from, button, listMessage, {
                quoted: ftrol
            })
        }
...
`
	prsimg = fs.readFileSync('./zeroyt7/zero.jpg')
               imeu = await zeroyt7.prepareMessage('0@s.whatsapp.net', prsimg, image)
               imeg = imeu.message.imageMessage
               res = await zeroyt7.prepareMessageFromContent(from,{
               "productMessage": {
               "product": {
               "productImage": imeg,
               "productId": "1",
               ...
               "productId": "2917227308401866",
                ...
                "businessOwnerJid": "6285157740529@s.whatsapp.net",
               }
              }, {quoted: ftrol})
